...
public final class EntityDef {
    ...
    public Model method160() {
        ...
        Model models[] = new Model[anIntArray73.length];

        for (int j = 0; j < anIntArray73.length; j++) {
            models[j] = Model.method462(anIntArray73[j]);
        }
        Model model;
    ...
    public Model method164(int j, int k, int ai[]) {
        ...
        if (model == null) {
            ...
            Model models[] = new Model[anIntArray94.length];

            for (int j1 = 0; j1 < anIntArray94.length; j1++) {
                models[j1] = Model.method462(anIntArray94[j1]);
            }
        ...
        model_1.method464(model, Class36.isNotMinus1(k) & Class36.isNotMinus1(j));
