    ...
    private void readValues(Stream stream) {
        do {
            ...
            if (i == 1) {
                ...
                anInt359 = stream.readUByte();
            } else if (i == 6) {
                anInt360 = stream.readUShort();
            } else if (i == 7) {
                anInt361 = stream.readUShort();
            } else if (i == 8) {
                anInt362 = stream.readUByte();
            } else if (i == 9) {
                anInt363 = stream.readUByte();
            } else if (i == 10) {
                anInt364 = stream.readUByte();
            } else if (i == 11) {
                anInt365 = stream.readUByte();
            } else if (i == 12) {
                stream.readUInt();
            } else {
